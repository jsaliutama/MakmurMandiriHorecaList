...
public class LilyAllItems extends AppCompatActivity {
    ...
    Button btnClose;
    int[] buttonList = {R.id.buttonLilyCanola,
            R.id.buttonLilySalad
    };
    ImageView imageView;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_lily_all_items);

        Toolbar toolbar = (Toolbar)findViewById(R.id.toolbarLilyAllItems);
        ...
        //Setup layout
        contentLayout = (LinearLayout) findViewById(R.id.lilyContentLayout);
        contentLayout.setBackgroundColor(Color.parseColor(WHITE));

        //Set buttons
        canola = (Button)findViewById(R.id.buttonLilyCanola);
        salad = (Button)findViewById(R.id.buttonLilySalad);
    ...
    private void btnOnClick(Button b) {
        try {
            ...
            LayoutInflater inflater = (LayoutInflater)LilyAllItems.this.getSystemService(Context.LAYOUT_INFLATER_SERVICE);
            ...
            switch (b.getId()){
                case R.id.buttonLilyCanola:
                    imageView.setImageResource(R.drawable.ic_unknown);
                    textNameEdit.setText(R.string.Lily_canola_label);
                    textWeightEdit.setText(R.string.Lily_canola_weight);
                    textPerCrtEdit.setText(R.string.Lily_canola_price);
                    break;
                case R.id.buttonLilySalad:
                    imageView.setImageResource(R.drawable.ic_unknown);
                    textNameEdit.setText(R.string.Lily_salad_label);
                    textWeightEdit.setText(R.string.Lily_salad_weight);
                    textPerCrtEdit.setText(R.string.Lily_salad_price);
                    break;
            }
            //Setup close button
