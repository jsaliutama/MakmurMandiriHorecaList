...
public class LogCabinAllItems extends AppCompatActivity {
    //Constants
    ...
    Button btnClose;
    int[] buttonList = {R.id.buttonLogCabinCountry,
            R.id.buttonLogCabinOriginal
    };
    ImageView imageView;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_log_cabin_all_items);

        Toolbar toolbar = (Toolbar)findViewById(R.id.toolbarLogCabinAllItems);
        ...
        //Set background
        contentLayout = (LinearLayout)findViewById(R.id.logCabinContentLayout);
        contentLayout.setBackgroundColor(Color.parseColor(WHITE));

        //Set buttons
        country = (Button)findViewById(R.id.buttonLogCabinCountry);
        original = (Button)findViewById(R.id.buttonLogCabinOriginal);
    ...
    private void btnOnClick(Button b) {
        try {
            ...
            LayoutInflater inflater = (LayoutInflater)LogCabinAllItems.this.getSystemService(Context.LAYOUT_INFLATER_SERVICE);
