...
public class SunnyAllItems extends AppCompatActivity {
    //Constants
    ...
    Button btnClose;
    int[] buttonList = {R.id.buttonSunnyPrunes};
    ImageView imageView;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_sunny_all_items);

        Toolbar toolbar = (Toolbar)findViewById(R.id.toolbarSunnyAllItems);
        ...
        //Set background
        contentLayout = (LinearLayout)findViewById(R.id.sunnyContentLayout);
        contentLayout.setBackgroundColor(Color.parseColor(WHITE));

        //Set Buttons
        sunny = (Button)findViewById(R.id.buttonSunnyPrunes);
    ...
    private void btnOnClick(Button b) {
        try {
            ...
            LayoutInflater inflater = (LayoutInflater)SunnyAllItems.this.getSystemService(Context.LAYOUT_INFLATER_SERVICE);
            ...
            switch (b.getId()){
                case R.id.buttonSunnyPrunes:
                    imageView.setImageResource(R.drawable.ic_unknown);
                    textNameEdit.setText(R.string.Sunny_prunes_label);
                    textWeightEdit.setText(R.string.Sunny_prunes_weight);
                    textPerCrtEdit.setText(R.string.Sunny_prunes_price);
                    break;
            }
            //Setup close button
