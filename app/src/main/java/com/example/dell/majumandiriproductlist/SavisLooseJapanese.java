...
public class SavisLooseJapanese extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_savis_loose_japanese);

        Toolbar toolbar = (Toolbar)findViewById(R.id.toolbarSavisLooseJapanese);
        ...
        //Setup layout
        contentLayout = (LinearLayout) findViewById(R.id.savisLooseJapaneseContentLayout);
    ...
    private void btnOnClick(Button b) {
        try {
            ...
            LayoutInflater inflater = (LayoutInflater)SavisLooseJapanese.this.getSystemService(Context.LAYOUT_INFLATER_SERVICE);
