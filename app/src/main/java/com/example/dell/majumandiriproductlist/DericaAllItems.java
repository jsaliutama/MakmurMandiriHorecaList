...
public class DericaAllItems extends AppCompatActivity {
    ...
    Button btnClose;
    int[] buttonList = {R.id.buttonDericaTomatoes};
    ImageView imageView;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_derica_all_items);

        Toolbar toolbar = (Toolbar)findViewById(R.id.toolbarDericaAllItems);
        ...
        //Set buttons
        tomatoes = (Button)findViewById(R.id.buttonDericaTomatoes);
    ...
    private void btnOnClick(Button b) {
        try {
            ...
            LayoutInflater inflater = (LayoutInflater)DericaAllItems.this.getSystemService(Context.LAYOUT_INFLATER_SERVICE);
