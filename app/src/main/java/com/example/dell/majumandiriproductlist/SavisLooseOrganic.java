...
public class SavisLooseOrganic extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_savis_loose_organic);

        Toolbar toolbar = (Toolbar)findViewById(R.id.toolbarSavisLooseOrganic);
        ...
        //Setup layout
        contentLayout = (LinearLayout) findViewById(R.id.savisLooseOrganicContentLayout);
    ...
    private void btnOnClick(Button b) {
        try {
            ...
            LayoutInflater inflater = (LayoutInflater)SavisLooseOrganic.this.getSystemService(Context.LAYOUT_INFLATER_SERVICE);
