...
public class SavisLooseAromatic extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_savis_loose_aromatic);

        Toolbar toolbar = (Toolbar)findViewById(R.id.toolbarSavisLooseAromatic);
        ...
        //Setup layout
        contentLayout = (ScrollView) findViewById(R.id.savisLooseAromaticContentLayout);
    ...
    private void btnOnClick(Button b) {
        try {
            ...
            LayoutInflater inflater = (LayoutInflater)SavisLooseAromatic.this.getSystemService(Context.LAYOUT_INFLATER_SERVICE);
