...
public class SavisLooseFruit extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_savis_loose_fruit);

        Toolbar toolbar = (Toolbar)findViewById(R.id.toolbarSavisLooseFruit);
        ...
        //Setup layout
        contentLayout = (LinearLayout) findViewById(R.id.savisLooseFruitContentLayout);
    ...
    private void btnOnClick(Button b) {
        try {
            ...
            LayoutInflater inflater = (LayoutInflater)SavisLooseFruit.this.getSystemService(Context.LAYOUT_INFLATER_SERVICE);
