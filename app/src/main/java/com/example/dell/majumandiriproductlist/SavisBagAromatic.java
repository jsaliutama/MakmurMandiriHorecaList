...
public class SavisBagAromatic extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_savis_bag_aromatic);

        Toolbar toolbar = (Toolbar)findViewById(R.id.toolbarSavisBagAromatic);
        ...
        //Set layout
        contentLayout = (ScrollView) findViewById(R.id.savisBagAromaticContentLayout);
    ...
    private void btnOnClick(Button b) {
        try {
            ...
            LayoutInflater inflater = (LayoutInflater)SavisBagAromatic.this.getSystemService(Context.LAYOUT_INFLATER_SERVICE);
